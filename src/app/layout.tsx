          ...
          <Sidebar>
            ...
            <SidebarContent className="">
              <div className="flex h-svh">
                ...
                <div className="flex justify-between pl-6 flex-col py-6 items-start w-full">
                      ...
                      !items.isDropDown ? (
                        ...
                        <SidebarMenu key={`sidebar_drop_${items.title}`}>
                          ...
                          >
                            <SidebarMenuItem>
                              <CollapsibleTrigger>
                                <div className="flex w-full flex-row items-center text-black gap-4">
                                  <span className="text-gray-400 size-5">
                                    {items.icon}
                                  </span>
                                  <span className="text-lg font-normal leading-6 tracking-wide ">
                                  ...
                                  <ChevronDown className="ml-auto size-5 transition-transform duration-500 ease-linear group-data-[state=open]/collapsible:rotate-180" />
                                </div>
                              </CollapsibleTrigger>
                                  ...
                                  {items.isDropDown &&
                                    ...
                                    items.dropdown.map((item, index) => (
                                      ...
                                      >
                                        ...
                                        >
                                          <span className="data-[active=true]:bg-green-700 text-[#031B15CC] text-[14px] font-normal leading-6 tracking-wide">
                                            {item}
                                          </span>
                                        </SidebarMenuSubButton>
                                      </SidebarMenuItem>
